...
public class ImgHelper {
    ...
    // 获取到YuvImage对象 然后存文件
    public static void useYuvImgSaveFile(Context context, ImageProxy imageProxy, boolean outputYOnly) {
        ...
        File file = new File(dir, "z_" + System.currentTimeMillis() + ".png");
        ...
        if (outputYOnly) { // 仅仅作为功能演示
            ...
            File yFile = new File(dir, "y_" + System.currentTimeMillis() + ".png");
    ...
    public static void saveYuvToFile(File file, int wid, int height, YuvImage yuvImage) {
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "saveYuvToFile e: " + e.getLocalizedMessage());
        }
    }
}
